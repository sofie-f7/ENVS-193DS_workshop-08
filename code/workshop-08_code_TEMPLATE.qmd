...
drought_exp_clean <- drought_exp |> # starting with drought_exp object
  ...
  mutate(species_name = as_factor(species_name),
         species_name = fct_relevel(species_name,
                                    ...
                                    "Grindelia camporum")) |> 
  # making sure water_treatment is a factor and ordering levels
...
AICc(model0,
     ...
     model2,
     model3,
     model4, #best model (lowest AIC): water treatment and species
     model5,
     model6,
     model7) |> 
...
On average, plant masses in drought stressed conditions were 0.12 $\pm$ 0.02g less than plant masses in well watered conditions and across species.

Across water treatments, all apcies have different (and higher) masses than _Lotus scoparius_ expect _Penstemon centranthifolius_.
